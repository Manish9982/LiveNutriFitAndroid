...
const WalkthroughExercise = (props) => {
      ...
      :
        <View style={styles.container}>
            ...
            <View style={styles.row}>
                <CopilotStep text={strings.excercisemsg1} order={1} name="thirText">
            ...
            <CopilotStep text={<Text>{strings.excercisemsg1}{"\n\n"}{strings.excercisemsg2} {"->"} {strings.excercisemsg3} <Image source={require('../../assets/icons/shuffel.png')} style={{ height: 15, width: 15, tintColor:"green" }} /> {strings.excercisemsg4} </Text>} order={5} name="thiText">
                ...
                {/* <CopilotStep text={<Text>{"Choose From One of these Options According to your Progress today\n\n"}You can go to Plans {"->"} Exercise Plan and then tap on "<Image source={require('../../assets/icons/switch.png')} style={{ height: 15, width: 15 }} />" icon to replace the {"exercise."}</Text>} order={2} name="secondText"> */}
