...
const WalkthroughMonitoring = (props) => {
    ...
    return (
        ...
        <View style={styles.container}>
            ...
            <View style={styles.row}>
                <CopilotStep text={strings.Observing} order={1} name="thirText">
            ...
            <View style={styles.row}>
                <CopilotStep text={strings.monitoringmsg3} order={3} name="thirdText">
