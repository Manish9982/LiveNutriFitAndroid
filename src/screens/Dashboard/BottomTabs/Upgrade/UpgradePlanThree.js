import { StyleSheet, View, TouchableOpacity, Dimensions, FlatList, Image } from 'react-native'
...
const UpgradePlanThree = () => {
  ...
  const renderItem = ({ item, index }) => {
    return (<View style={styles.cardContainer}>
      ...
      <Text style={{ fontSize: fontSizes.EXTRASM, color: 'silver' }}>{item.description}</Text>
...
export default UpgradePlanThree
