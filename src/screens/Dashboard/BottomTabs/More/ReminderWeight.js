...

                {
                    show == true ? <DateTimePicker
                        ...
                        onChange={(t) => {
                            ...
                            storeDataInLocalStorage('alarm', JSON.stringify(date))
                        }}
                    />
                        :
                        null
                }
                {
                    show2 == true ? <DateTimePicker
                        ...
                        onChange={(t) => {
                            ...
                            storeDataInLocalStorage('alarm', JSON.stringify(date2))
                        }}
                    />
                        :
                        null
                }
                {
                    show3 == true ? <DateTimePicker
                        ...
                        onChange={(t) => {
                            ...
                            storeDataInLocalStorage('alarm', JSON.stringify(date3))
                        }}
                    />
                        :
                        null
                }
                {
                    show4 == true ? <DateTimePicker
                        ...
                        onChange={(t) => {
                            ...
                            storeDataInLocalStorage('alarm', JSON.stringify(date4))
                        }}
                    />
                        :
                        null
                }
                {
                    show5 == true ? <DateTimePicker
                        ...
                        onChange={(t) => {
                            ...
                            storeDataInLocalStorage('alarm', JSON.stringify(date5))
                        }}
                    />
                        :
                        null
                }
                {
                    show6 == true ? <DateTimePicker
                        ...
                        onChange={(t) => {
                            ...
                            storeDataInLocalStorage('alarm', JSON.stringify(date6))
