...
const SubmitFasting = () => {
    ...
    return (
        ...
        loader ?
            ...
            :
            <View>
                <HeaderForSubmissionScreens Title={strings.FastingProgress} />
                <View style={styles.mainContainer}>
                    ...
                    <Text style={{ fontFamily: 'Montserrat-SemiBold', fontSize: fontSizes.XXL }}>{strings.FastingProgress}</Text>
